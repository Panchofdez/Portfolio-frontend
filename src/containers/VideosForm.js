...
class VideosForm extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      title: this.props.location.state
        ? this.props.location.state.video.title
        : "",
      description: this.props.location.state
        ? this.props.location.state.video.description
        : "",
      link: this.props.location.state
        ? this.props.location.state.video.link
        : "",
    };
  }
  handleChange = (e) => {
  ...
  render() {
    ...
    const videosAdded = videos.map((video) => {
      return (
        <div key={video} className="alert alert-success">
        ...
        <div className="col-md-8 col-10">
          {this.props.video ? (
            ...
            <React.Fragment>
              <h3>Videos</h3>
              <p>
                Share your videos from youtube by copying and pasting your
                youtube video link
              </p>
            </React.Fragment>
          )}
...
export default connect(null, { addErrorMessage, createVideo, editVideo })(
  VideosForm
);
