        ...
        <div key={u._id} className="card col-lg-6 p-0 endorse-cards">
          <div className="row no-gutters">
            <div className="col-md-4 col-3">
              <img
                src={newImage}
                className="card-img user-card-img img-fluid"
                alt=""
            ...
            <div className="col-md-8 col-9">
              <div className="card-body d-flex flex-lg-column flex-row justify-content-lg-center justify-content-between align-items-start">
                ...
                <button
                  ...
                  onClick={() =>
                    this.props.history.push(`/portfolios/${u.portfolio}`)
                  }
                >
    ...
    return (
      <div className="p-3">
        ...
        <div className="tab-content" id="pills-tabContent">
          ...
          >
            <div className="row p-3">{recommendationCards}</div>
          </div>
          <div
          ...
          >
            <div className="row  p-3">{recommendingCards}</div>
          </div>
        </div>
      </div>
    );
