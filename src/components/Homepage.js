	...
	return (
		<React.Fragment>
			<div className="container flex-column landing text-center align-items-center">
				...
				<div className="container-fluid" style={{minHeight:'250px', opacity:'0.92', backgroundColor:'#161716'}}>
					<div className="row container m-auto">
						<div className="col-md-4 mt-5 border-right text-center">
							<i className="fas fa-camera mx-2 homepageText"></i>
